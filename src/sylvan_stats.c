...
} sylvan_report_info[] =
{
    ...
    {2, ZDD_CLAUSE_SAT, "ZDD cl_sat" },
    {2, ZDD_CLAUSE_SUPPORT, "ZDD cl_support" },
    {2, ZDD_CLAUSE_ISOC, "ZDD isoc" },
    {2, ZDD_CLAUSE_UP, "ZDD up" },
    {2, ZDD_CLAUSE_OR, "ZDD or" },
    {2, ZDD_CLAUSE_EXPAND, "ZDD expand" },
    {2, ZDD_CLAUSE_SUBSUME, "ZDD subsume" },
    {2, ZDD_CLAUSE_SELF_SUBSUME, "ZDD ssubsume" },
