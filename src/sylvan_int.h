...
#define CACHE_ZDD_DIFF                  (89LL<<40)
#define CACHE_ZDD_EXISTS                (90LL<<40)
#define CACHE_ZDD_PROJECT               (91LL<<40)
#define CACHE_ZDD_CLAUSE_ENVIRONMENT    (92LL<<40)
#define CACHE_ZDD_CLAUSE_SAT            (93LL<<40)
#define CACHE_ZDD_CLAUSE_SUPPORT        (94LL<<40)
#define CACHE_ZDD_CLAUSE_ISOC           (95LL<<40)
#define CACHE_ZDD_CLAUSE_UP             (96LL<<40)
#define CACHE_ZDD_CLAUSE_EXPAND         (97LL<<40)
#define CACHE_ZDD_CLAUSE_SUBSUME        (98LL<<40)
#define CACHE_ZDD_CLAUSE_SELF_SUBSUME   (99LL<<40)
#define CACHE_ZDD_CLAUSE_OR             (100LL<<40)
