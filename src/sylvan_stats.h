...
typedef enum {
    ...
    OPCOUNTER(ZDD_CLAUSE_ENVIRONMENT),
    OPCOUNTER(ZDD_CLAUSE_SAT),
    OPCOUNTER(ZDD_CLAUSE_SUPPORT),
    OPCOUNTER(ZDD_CLAUSE_ISOC),
    OPCOUNTER(ZDD_CLAUSE_UP),
    OPCOUNTER(ZDD_CLAUSE_OR),
    OPCOUNTER(ZDD_CLAUSE_EXPAND),
    OPCOUNTER(ZDD_CLAUSE_SUBSUME),
    OPCOUNTER(ZDD_CLAUSE_SELF_SUBSUME),
